...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Без безкрайно прелистване на профили. Ние сме подбрана услуга. Лично преглеждаме всеки профил и правим запознанства само когато наистина вярваме в съвместимостта. Мисли за нас като за много внимателен приятел с диплома по психология.",
  },
  {
