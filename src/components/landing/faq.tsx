...
const faqs = [
  {
    ...
    answer:
      "Тестът е разработен от нашия екип експерт-психолози и включва 25 въпроса, които разкриват основните ти нагласи към връзките. На базата на отговорите получаваш личностен профил, който използваме за подбора на съвместими кандидати.",
  },
  {
