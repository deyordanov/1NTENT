...
export const questions: Question[] = [
  {
    ...
    options: [
      ...
      { label: "Брънч с близки приятели", value: "social" },
  ...
  {
    id: "q3",
    text: "По скала от 1 до 5, колко готовност имаш за сериозна връзка точно сега?",
    type: "scale",
    min: 1,
    max: 5,
    minLabel: "Не съвсем",
  ...
  {
    id: "q5",
    text: "Три срещи с някого. Нещата вървят добре. Какво те притеснява най-много?",
    type: "choice",
    options: [
